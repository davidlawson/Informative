#
#  Be sure to run `pod spec lint Informative.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "David Lawson" => "tech.lawson@gmail.com" }
  # Or just: s.author    = "David Lawson"
  # s.authors            = { "David Lawson" => "tech.lawson@gmail.com" }
  # s.social_media_url   = "http://twitter.com/David Lawson"
